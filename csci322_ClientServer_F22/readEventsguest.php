...
<form   name="dropDownform" action="readSeatingChartguest.php"  method="POST">
	<b><h1>Days of the Week</b></h1> <p><p>

	Use the drop down list to select a show. Click the <b>next button</b> to see the available rooms for that date.
	<p><p>
	<?php
